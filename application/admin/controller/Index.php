...
class Index extends Base{
    ...
    public function article(){
        ...
        $list->add_Crumb("资讯管理",Url())
            ...
            ->add_field("title","名字","text",["width"=>"10%","placeholder"=>"测试place","value"=>"123","validate"=>"require|max:25"])
            ->add_field("fenlei","分类栏目","select",["options"=>["1"=>"选择1","2"=>["选择2","selected"]]])
            ->add_field("pinglun","允许评论","checkbox")
            ->add_field("detail","详情","editor",["validate"=>"require|max:1000"],["add","edit"])
            ->add_field("selltime","销售时间","date",["validate"=>"require"])
            ...
            ->add_field("file1","文件","file",null,["add","edit"])
            ->set_name("资讯")
